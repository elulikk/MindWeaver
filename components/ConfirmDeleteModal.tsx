      ...
      >
        <div className="flex-grow p-6 flex flex-col space-y-4">
          <div className="flex items-start gap-4">
              <div className="flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center bg-red-900/50">
                  <Icon icon="warning" className="h-8 w-8 text-red-500" />
              </div>
              <div>
        ...
        <div className="flex-shrink-0 flex justify-end items-center gap-3 p-4 border-t border-zinc-700">
          ...
          <button
            ...
            onClick={onConfirm}
            className="px-4 py-2 font-semibold text-white bg-red-600 rounded-md hover:bg-red-700 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 cursor-pointer"
          >
            {confirmText}
          </button>
        </div>
